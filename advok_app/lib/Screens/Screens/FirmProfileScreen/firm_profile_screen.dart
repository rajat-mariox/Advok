        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              _buildSectionLabel('Firm Information'),
              _buildSectionCard(
                children: [
                  ProfileInfoRow(
                    icon: 'assets/icons/ic_office.svg',
                    label: 'Founded',
                    value: (Session.profile?['foundedYear'] as String?) ?? '—',
                  ),
                  _buildInsetDivider(),
                  ProfileInfoRow(
                    ...
                    value:
                        (Session.profile?['contactPerson'] as String?) ?? '—',
                  ),
                  _buildInsetDivider(),
                  ProfileInfoRow(
                    ...
                    value:
                        (Session.profile?['officialEmail'] as String?) ?? '—',
                  ),
                  _buildInsetDivider(),
                  ProfileInfoRow(
                    icon: 'assets/icons/ic_phone.svg',
                    label: 'Main Phone',
                    value: (Session.profile?['mainPhone'] as String?) ?? '—',
                  ),
                ],
              ),
        ...
        children: [
          ...
          Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(20),
              onTap: () {
                // TODO: Open the edit firm profile screen.
              },
              child: Container(
