...
/// with student-specific info and verification status.
...
class _StudentProfileScreenState extends State<StudentProfileScreen> {
              ...
              _buildSectionCard(
                children: [
                  ProfileInfoRow(
                    ...
                    value: (Session.profile?['college'] as String?) ?? '—',
                  ),
                  _buildInsetDivider(),
                  ProfileInfoRow(
                    icon: 'assets/icons/ic_book_open.svg',
                    label: 'Course',
                    value: (Session.profile?['course'] as String?) ?? '—',
                  ),
                  _buildInsetDivider(),
                  ProfileInfoRow(
              ...
              _buildSectionCard(
                children: [
                  ProfileMenuRow(
                    ...
                    onTap: () => _openSheet(const RateSheet()),
                  ),
                  _buildInsetDivider(),
                  ProfileMenuRow(
                    ...
                    onTap: () => _openSheet(const ShareSheet()),
                  ),
                  _buildInsetDivider(),
                  ProfileMenuRow(
                  ...
                  ProfileMenuRow(
                    ...
                    onTap: () => _openSheet(const AboutSheet()),
                  ),
                ],
              ),
              ...
              _buildSectionCard(
                children: [
                  ...
                  ProfileMenuRow(
                    ...
                    onTap: () => _openSheet(const DeleteAccountSheet()),
                  ),
                ],
              ),
            ],
  ...
  Future<void> _openSheet(Widget sheet) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              _buildStatCard('0', 'Cases Read'),
              const SizedBox(width: 8),
              _buildStatCard('0', 'Saved'),
              const SizedBox(width: 8),
              _buildStatCard('0', 'Mentors'),
            ],
          ),
        ],
      ),
